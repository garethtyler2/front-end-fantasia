      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          <div className="inline-flex items-center rounded-full border border-white/10 bg-white/5 px-4 py-1.5 text-sm font-medium mb-6 animate-fade-in" style={{ animationDelay: "200ms" }}>
            <span className="text-brand-purple">✨ AI-Powered Rehabilitation</span>
            <span className="mx-2">—</span>
            <span>Your health journey starts here</span>
          </div>
          
          <h1 className="animate-fade-in" style={{ animationDelay: "400ms" }}>
            <span className="block">Your Virtual Physiotherapist:</span>
            <span className="gradient-text">AI-Powered Rehab, Prehab, and Personal Training</span>
          </h1>
          
          <p className="mt-6 text-lg text-muted-foreground max-w-2xl animate-fade-in" style={{ animationDelay: "600ms" }}>
            AI-Rehab is your affordable and accessible alternative to traditional physiotherapy. Identify injuries, design recovery plans, and achieve peak physical performance.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-10 animate-fade-in" style={{ animationDelay: "800ms" }}>
            <Button className="hero-button-primary" asChild>
              <Link to="/injury-diagnosis">
                Start Your Virtual Physio Session <ArrowRight className="ml-2 h-4 w-4" />
              </Link>
            </Button>
          ...
          <p className="mt-10 text-sm text-muted-foreground max-w-2xl animate-fade-in" style={{ animationDelay: "1200ms" }}>
            Whether you're looking for online physiotherapy, a virtual physio session from home, or an AI physiotherapist, our platform delivers personalized care at your fingertips. Save time, save money, and get the expert support you need—no matter where you are.
          </p>
        </div>
      </div>
    </section>
